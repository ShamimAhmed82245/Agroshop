		...
		<div class="container">
			...
			<?php
				...
				while($count<$countEnd){
					...
					<div class="seed">
						<?php
						$query="SELECT * FROM equipment LIMIT $start,$end";
						...
						while ($row=mysqli_fetch_assoc($result)) {
							...
							<div class="seed-logo">
									<a href="single.php?prod_id=<?php echo $p_id;?>&prod_cat=<?php echo $p_cat;?>">
										<img src="img/equipment/<?php echo $p_image;?>">
										<div class="prod-des">
											<ul>
											<li>নাম : <?php echo  substr($p_name, 0,50);?></li>
			...
			<div class="page">
				<?php
					for ($i=1; $i <=$total_page ; $i++) { 
						?>
							<div class="page-num">
								<a href="equipments.php?no_page=<?php echo $i;?>"><?php echo $i;?></a>
							</div>
						<?php
					}
				?>
