...
if (isset($_POST['reset-password'])) {
  ...
  if (count($errors) == 0) {
    ...
    $to = $email;
    $subject = "Reset your password on agroshop.com";
    $msg = "Hi there, click on this <a href=\"new_password.php?token=" . $token . "\">link</a> to reset your password on our site";
    //$msg = wordwrap($msg,70);
    $headers = "From: shamimahmed82245@gmail.com";
...
if (isset($_POST['new_password'])) {
  ...
  $new_pass_c = $_POST['new_pass_c'];// mysqli_real_escape_string($db, $_POST['new_pass_c']);
