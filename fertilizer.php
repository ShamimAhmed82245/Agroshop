		...
		<div class="container">
			...
			<?php
				...
				while($count<$countEnd){
					...
					<div class="seed">
						<?php
						$query="SELECT * FROM fertilizer LIMIT $start,$end";
							...
							<div class="seed-logo">
									<a href="single.php?prod_id=<?php echo $p_id;?>&prod_cat=<?php echo $p_cat;?>">
										...
										<div class="prod-des">
											...
											<li>ওজন : <?php echo $p_weight;?> কেজি</li>
			...
			<div class="page">
				<?php
					for ($i=1; $i <=$total_page ; $i++) { 
						?>
							<div class="page-num">
								<a href="fertilizer.php?no_page=<?php echo $i;?>"><?php echo $i;?></a>
							</div>
						<?php
					}
				?>
