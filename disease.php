		...
		<div class="container">
			...
			<?php
				...
				while($count<$countEnd){
					...
					<div class="dis">
						<?php
						$query="SELECT * FROM 	disease LIMIT $start,$end";
						...
						while ($row=mysqli_fetch_assoc($result)) {
							...
							?>
							<div class="dis-logo">
									<a href="diseasedetail.php?prod_id=<?php echo $p_id;?>&prod_cat=<?php echo $p_cat;?>">
										<img src="img/disease/<?php echo $p_image;?>">
										<div class="dis-des">
											<p><?php echo $desone;?></p>
										</div>
			...
			<div class="page">
				<?php
					for ($i=1; $i <=$total_page ; $i++) { 
						?>
							<div class="page-num">
								<a href="disease.php?no_page=<?php echo $i;?>"><?php echo $i;?></a>
							</div>
						<?php
					}
				?>
